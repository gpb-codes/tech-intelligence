...
original_title: 'Kubernetes v1.36: More Drivers, New Features, and the Next Era of
  DRA'
company: ''
product: Kubernetes
version: '1.36'
date: '2026-05-07'
created: '2026-05-07T18:35:00+00:00'
updated: '2026-08-19T17:28:45+00:00'
...
| Requisitos | Kubernetes 1.36 or later |
| Cambios incompatibles | Dynamic Resource Allocation (DRA) continues to mature, bringing a wave of feature graduations, critical usability improvements, and new capabilities. |
| Precio | 💰 Gratis |

> [!abstract] Resumen
>
> *   **Kubernetes v1.36**: Actualización de los drivers, nuevas características y el próximo eramo de asignación dinámica de recursos.
> *   **DRA**: Asignación dinámica de recursos (ADR) ha cambiado la forma en que los administradores de plataforma gestionan accesorios de hardware y recursos especializados en Kubernetes.
> *   **V1.36 release**: Actualización de la versión de lanzamiento, con graduaciones de características, mejoras de usabilidad crítica y nuevas capacidades que extenden la flexibilidad de ADR a recursos nativos como memoria y CPU.
> *   **Driver availability**: Disponibilidad de los drivers.
> *   **Relevancia**: Relevancia de la actualización para los usuarios de Kubernetes.

## ¿Qué ocurrió? ⚔️

> [!info] Traducción del anuncio
>
> Kubernetes v1.36: More Drivers, New Features, and the Next Era of Dynamic Resource Allocation
> 
> Dynamic Resource Allocation (DRA) has fundamentally changed how platform administrators handle hardware accelerators and specialized resources in Kubernetes. In the v1.36 release, DRA continues to mature, bringing a wave of feature graduations, critical usability improvements, and new capabilities that extend the flexibility of DRA to native resources like memory and CPU, and support for ResourceClaims in PodGroups. Driver availability continues to expand.
...
> - Granos de lanzamiento significativos
...
- **DRA (Dynamic Resource Allocation)** — confianza: high
- **ResourceClaims** — confianza: medium

## Fuente original 📜

[https://kubernetes.io/blog/2026/05/07/kubernetes-v1-36-dra-136-updates/](https://kubernetes.io/blog/2026/05/07/kubernetes-v1-36-dra-136-updates/)

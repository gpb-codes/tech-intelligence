...
original_title: 'Kubernetes v1.36: Admission Policies That Can''t Be Deleted'
company: ''
product: Kubernetes
version: '1.36'
date: '2026-05-04'
created: '2026-05-04T18:35:00+00:00'
updated: '2026-08-18T23:31:19+00:00'
...
| Requisitos | Kubernetes 1.36.0-rc.1 |
| Cambios incompatibles | No hay cambios incompatibles |
| Precio | 💰 Gratis |

> [!abstract] Resumen
>
> *   Control Admission Policies (CAP) en Kubernetes v1.36: se implementan mediante API objetos para controlar el acceso a los recursos de la infraestructura.
> *   API objetos: se utilizan para definir las políticas de control de acceso, permitiendo a los administradores de la infraestructura controlar quién puede acceder a los recursos.
> *   Control de acceso: se implementan diferentes políticas de control de acceso, como la autorización de usuarios y grupos, la verificación de credenciales y la exclusión de usuarios no autorizados.
> *   API objetos: se utilizan para definir las políticas de control de acceso, permitiendo a los administradores de la infraestructura controlar quién puede acceder a los recursos.
> *   Relevancia: es relevante para la seguridad y la gestión de la infraestructura, ya que permite a los administradores controlar el acceso a los recursos y prevenir ataques no autorizados.

## ¿Qué ocurrió? ⚔️

> [!info] Traducción del anuncio
>
> Kubernetes v1.36: Control Admission Policies con API objetos
...
>
> - Kubernetes v1.36: Control Admission Policies con API objetos
> - Control Admission Policies (CAP) son una herramienta fundamental para garantizar la seguridad y la escalabilidad de los sistemas de Kubernetes.
> - API objetos permiten una mayor flexibilidad y personalización en la implementación de CAP en Kubernetes.
...
- **API Gateways** — confianza: high
- **Service Meshes** — confianza: medium

## Fuente original 📜

[https://kubernetes.io/blog/2026/05/04/kubernetes-v1-36-manifest-based-admission-control/](https://kubernetes.io/blog/2026/05/04/kubernetes-v1-36-manifest-based-admission-control/)

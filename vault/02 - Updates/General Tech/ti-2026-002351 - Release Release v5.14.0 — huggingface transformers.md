...
updated: '2026-08-18T08:01:49+00:00'
...
| Cambios incompatibles | GPTNeoX now remaps `embed_out` to `lm_head` and GPTBigCode has `_supports_attention_backend = True` enabled. |

> [!abstract] Resumen
>
> * Release v5.14.0: Se lanzó el modelo Inkling, una general-purpose multimodal que acepta inputs de texto, imágenes y audio y genera outputs de texto.
> * Inkling: Se agregaron 975B de total y 41B de activo, y se introdujo el modelo Inkling (fresh from Thinking Machines).
> * TIPSv2: Se agregaron TIPSv2 (#46347) por @Ternura143, que se utilizó para mejorar la documentación del modelo.
> * TIPSv2 DPT: Se agregaron TIPSv2 (#46347) por @Ternura143, que se utilizó para mejorar la documentación del modelo.
> * Breaking changes: Se remaparon los outputs de GPTNeoX a `lm_head` y se activó el `_supports_attention_backend = True` en GPTBigCode.
...
> [!info] ¿Qué es?
>
> La tecnología de modelo de textos multimodales Hugging Face Transformers ofrece modelos generalizados para procesar y generar texto, imágenes y audios, y se utiliza en diversas aplicaciones de inteligencia artificial y desarrollo de aplicaciones móviles.

> [!tip] ¿En qué ayuda al desarrollo?
>
> Esta tecnología proporciona modelos de alta precisión y flexibilidad para desarrolladores de aplicaciones móviles, lo que les permite crear herramientas de desarrollo personalizadas y automatizar tareas complejas.

### Relevancia por perfil

| Perfil | Relevancia | Debes saber / actualizarte |
| --- | --- | --- |
| Trainee | Alta | Modelos de textos multimodales para procesamiento de texto, imágenes y audios · Integración con aplicaciones móviles y desarrollo de aplicaciones personalizadas · Uso de técnicas de aprendizaje automático y optimización para mejorar la precisión y la eficiencia |
| Junior | Media | Uso de modelos de textos multimodales para generar contenido personalizado y automatizar tareas · Integración con herramientas de desarrollo de aplicaciones móviles y plataformas de creación de contenido · Aprendizaje automático y optimización para mejorar la precisión y la eficiencia en la generación de contenido |
| Semi-Senior | Baja | Uso de modelos de textos multimodales para procesamiento de texto y generación de contenido · Integración con herramientas de desarrollo de aplicaciones móviles y plataformas de creación de contenido · Aprendizaje automático y optimización para mejorar la precisión y la eficiencia en la generación de contenido |
| Senior | Alta | Uso de modelos de textos multimodales para procesamiento de texto y generación de contenido de alta calidad · Integración con herramientas de desarrollo de aplicaciones móviles y plataformas de creación de contenido · Aprendizaje automático y optimización para mejorar la precisión y la eficiencia en la generación de contenido |
| Ingeniero de Software | Alta | Uso de modelos de textos multimodales para procesamiento de texto y generación de contenido de alta calidad · Integración con herramientas de desarrollo de aplicaciones móviles y plataformas de creación de contenido · Aprendizaje automático y optimización para mejorar la precisión y la eficiencia en la generación de contenido |
| Ingeniero en Redes | Alta | Uso de modelos de textos multimodales para procesamiento de texto y generación de contenido de alta calidad · Integración con herramientas de desarrollo de aplicaciones móviles y plataformas de creación de contenido · Aprendizaje automático y optimización para mejorar la precisión y la eficiencia en la generación de contenido |
| DevOps / SRE | Alta | Uso de modelos de textos multimodales para procesamiento de texto y generación de contenido de alta calidad · Integración con herramientas de desarrollo de aplicaciones móviles y plataformas de creación de contenido · Aprendizaje automático y optimización para mejorar la precisión y la eficiencia en la generación de contenido |
| Ciberseguridad | Alta | Uso de modelos de textos multimodales para procesamiento de texto y generación de contenido de alta calidad · Integración con herramientas de desarrollo de aplicaciones móviles y plataformas de creación de contenido · Aprendizaje automático y optimización para mejorar la precisión y la eficiencia en la generación de contenido |

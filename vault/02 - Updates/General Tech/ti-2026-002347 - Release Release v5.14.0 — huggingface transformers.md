...
type: update
id: ti-2026-002347
title: 'Release: Release v5.14.0 — huggingface/transformers'
aliases:
- 'Release: Release v5.14.0 — huggingface/transformers'
original_title: 'Release: Release v5.14.0 — huggingface/transformers'
company: ''
product: ''
version: 5.14.0
date: '2026-07-15'
created: '2026-07-15 19:02:19'
updated: '2026-08-18T20:14:42+00:00'
...
> [!abstract] Resumen
>
> * Release v5.14.0: Agrega Inkling modelo #47347
> * Inkling: modelo general-purpose multimodal que acepta inputs de texto, imagen y audio y genera outputs de texto
> * Inkling se utiliza en inglés y otros idiomas, y se utiliza en múltiples lenguas de codificación
> * Inkling se libera con pesos abiertos para apoyar la investigación, la fine-tuning y la integración en productos terceros
> * TIPSv2: Agrega TIPSv2 (#46347) por @Ternura143 en [#46347]
> * TIPSv2 DPT: Agrega TIPSv2 (#46347) por @Ternura143 en [#46347]
...
> Release: Release v5.14.0 — huggingface/transformers
> 
> # Release v5.14.0 ## Nuevos modelos adiciones ### Inkling (fresh de Thinking Machines): 975B total, 41B active * Agrega Inkling modelo #47347 por @molbap @Cyrilvallez @eustlb y @zucchini-nlp Inkling es un modelo general-purpose multimodal que acepta inputs de texto, imagen y audio y genera outputs de texto. Está diseñado para el uso en inglés y otros idiomas, y se utiliza en múltiples lenguas de codificación. Se utiliza para desarrolladores que construyen aplicaciones de inteligencia artificial, incluidos sistemas agenticos y herramientas de asistencia de código, chatbots y sistemas de generación de texto, y se utiliza para tareas naturales de conversación y generación de texto y multimodal. Se libera con pesos abiertos para apoyar la investigación, la fine-tuning y la integración en productos terceros. ### TIPSv2 **Enlaces:** [Documentación](https://huggingface.co/docs/transformers/main/en/model_doc/tipsv2) * Agrega TIPSv2 (#46347) por @Ternura143 en [#46347] ### TIPSv2 DPT **Enlaces:** [Documentación](https://huggingface.co/docs/transformers/main/en/model_doc/tipsv2_dpt) * Agrega TIPSv2 (#46347) por @Ternura143 en [#46347]

## ¿Por qué importa? 🛡️

> [!success] Impacto
>
> - Nuevos modelos adiciones
> - Inkling (fresh de Thinking Machines)
> - TIPSv2
...
> [!info] ¿Qué es?
>
> La tecnología de modelo de lenguaje multimodal Hugging Face Transformers es una plataforma de inteligencia artificial que permite a los desarrolladores crear modelos de lenguaje personalizados para aplicaciones de inteligencia artificial, chatbots y sistemas de generación de texto y multimodal.

> [!tip] ¿En qué ayuda al desarrollo?
>
> Esta tecnología ofrece varias ventajas en el desarrollo de software y sistemas, como la capacidad de generar texto y multimodal, la fine-tuning de modelos y la integración en productos terceros, lo que la hace ideal para desarrolladores que buscan crear aplicaciones más inteligentes y personalizadas.

### Relevancia por perfil ⚔️

| Perfil | Relevancia | Debes saber / actualizarte |
| --- | --- | --- |
| Trainee | Alta | La capacidad de generar texto y multimodal de alta calidad · La fine-tuning de modelos para adaptarse a diferentes lenguas y contextos · La integración en productos terceros y la colaboración con otros desarrolladores |
| Junior | Media | La capacidad de trabajar con diferentes lenguas y formatos de entrada · La capacidad de fine-tuning de modelos para mejorar la precisión y la eficiencia · La capacidad de colaborar con otros desarrolladores y equipos |
| Semi-Senior | Alta | La capacidad de liderar proyectos de desarrollo de modelos de lenguaje · La capacidad de fine-tuning de modelos para mejorar la precisión y la eficiencia · La capacidad de colaborar con otros desarrolladores y equipos en proyectos de investigación y desarrollo |
| Senior | Alta | La capacidad de liderar equipos de desarrollo de modelos de lenguaje · La capacidad de fine-tuning de modelos para mejorar la precisión y la eficiencia · La capacidad de colaborar con otros desarrolladores y equipos en proyectos de investigación y desarrollo |
| Ingeniero de Software | Alta | La capacidad de diseñar y desarrollar modelos de lenguaje personalizados · La capacidad de fine-tuning de modelos para mejorar la precisión y la eficiencia · La capacidad de colaborar con otros desarrolladores y equipos en proyectos de investigación y desarrollo |
| Ingeniero en Redes | Alta | La capacidad de diseñar y desarrollar modelos de lenguaje para redes de datos · La capacidad de fine-tuning de modelos para mejorar la precisión y la eficiencia · La capacidad de colaborar con otros desarrolladores y equipos en proyectos de investigación y desarrollo |
| DevOps / SRE | Alta | La capacidad de diseñar y desarrollar modelos de lenguaje para sistemas de gestión de aplicaciones · La capacidad de fine-tuning de modelos para mejorar la precisión y la eficiencia · La capacidad de colaborar con otros desarrolladores y equipos en proyectos de investigación y desarrollo |
| Ciberseguridad | Baja | La capacidad de diseñar y desarrollar modelos de lenguaje para sistemas de seguridad · La capacidad de fine-tuning de modelos para mejorar la precisión y la eficiencia · La capacidad de colaborar con otros desarrolladores y equipos en proyectos de investigación y desarrollo |
...
- **TIPSv2** — confianza: high
- **TIPSv2 DPT** — confianza: high

## Fuente original 📜

[https://github.com/huggingface/transformers/releases/tag/v5.14.0](https://github.com/huggingface/transformers/releases/tag/v5.14.0)

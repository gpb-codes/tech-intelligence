...
original_title: New Conversion from cgroup v1 CPU Shares to v2 CPU Weight
company: ''
product: ''
version: '1.0'
date: '2026-01-30'
created: '2026-01-30T16:00:00+00:00'
updated: '2026-08-18T23:56:18+00:00'
...
| Requisitos | cgroup v2, Kubernetes 1.23+ |
| Cambios incompatibles | Replaced cgroup v1 CPU shares with cgroup v2 CPU weight |

> [!abstract] Resumen
>
> *   La implementación de un nuevo proceso de conversión de cgroups v1 CPU shares a v2 CPU weight.
> *   El objetivo es mejorar la asignación de prioridad de CPU para trabajos en sistemas con cgroups v2.
> *   El cgroup v2 tiene un nuevo formato de CPU weight que permite una mayor precisión en la asignación de prioridad.
> *   La mejora de la conversión de cgroups v1 a v2 permite una mayor eficiencia en la asignación de recursos.
> *   La implementación de este proceso es relevante para los sistemas operativos con cgroups v2 y para los entornos de Kubernetes.
...
> [!success] Impacto
>
> - Lanzamiento disruptivo de la nueva forma de convertir shares de CPU en peso en cgroup v2
> - Cambios significativos de producto en la forma en que se asigna la prioridad de CPU en Kubernetes
> - Nuevos modelos importantes en la implementación de la nueva forma de convertir shares de CPU en peso en cgroup v2
...
- **cgroup v2 CPU Weight** — confianza: high
- **cgroup v1 CPU Shares** — confianza: medium

## Fuente original 📜

[https://kubernetes.io/blog/2026/01/30/new-cgroup-v1-to-v2-cpu-conversion-formula/](https://kubernetes.io/blog/2026/01/30/new-cgroup-v1-to-v2-cpu-conversion-formula/)
